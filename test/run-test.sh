...
function run_byond_tests {
    ...
    run_test "build map unit tests" "scripts/dm.sh -DUNIT_TEST -M$MAP_PATH ofstation12.dme"
    run_test "check no warnings in build" "grep ', 0 warnings' build_log.txt"
    run_test "run unit tests" "DreamDaemon ofstation12.dmb -invisible -trusted -core 2>&1 | tee log.txt"
