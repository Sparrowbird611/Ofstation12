...
/obj/item/paper/lar_maria/note_5
	...
	info = {"<center><b><span style='color: green'>Zeng-Hu Pharmaceuticals</span></b></center>
			<center><span style='color: red'><small>CONFIDENTIAL USE ONLY</small></span></center>
			This is a reminder to all facility staff, while we may be doing important work for the good of humanity here, our methods are not necessarily one hundred percent legal under SA law, and as such you are NOT permitted, as outlined in your contract, to discuss the nature of your work, nor any other related information, with anyone not directly involved with the project without express permission of your facility director. This includes family, friends, local or galactic news outlets and bluenet chat forums.
			"}
...
/obj/item/paper/lar_maria/note_7
	...
	info = {"<center><b><span style='color: green'>Zeng-Hu Pharmaceuticals</span></b></center>
			<center><span style='color: red'><small>CONFIDENTIAL USE ONLY</small></span></center>
			<i>Can we get some more diversity in test subjects? I know we're mostly working off SA undesirables, but martians and frontier colonists aren't exactly the most varied bunch. We could majorly benefit from having some Skrell test subjects, for example. Oooh, or one of those GAS things Xynergy's got a monopoly on.</i>
			"}
