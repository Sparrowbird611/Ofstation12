...
/datum/map/torch/get_map_info()
	...
	. +=  "The vessel is staffed with a mix of SA government personnel and hired contractors."
	. +=  "This area of space is uncharted, away from SA territory. You might encounter remote outposts or drifting hulks, but no recognized government holds claim on this sector."
	return jointext(., "<br>")
