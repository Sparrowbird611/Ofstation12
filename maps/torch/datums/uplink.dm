/datum/uplink_item/item/visible_weapons/m22f
	name = "Service Pistol, SA, Heavy"
	desc = "A Hephaestus Industries M22F. A large pistol issued as an SADF service weapon."
	item_cost = 40
	path = /obj/item/gun/projectile/pistol/m22f


/datum/uplink_item/item/visible_weapons/m19
	name = "Service Pistol, SA, Light"
	desc = "A Hephaestus Industries M19. A light pistol issued as an SADF service weapon."
	item_cost = 32
