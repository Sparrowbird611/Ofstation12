/obj/item/clothing/suit/armor/vest/solgov
	name = "\improper Solar Authority armored vest"
	desc = "A synthetic armor vest. This one is marked with the crest of the Solar Authority."
	icon_state = "solvest"
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')

/obj/item/clothing/suit/storage/vest/solgov
	name = "\improper Solar Authority heavy armored vest"
...
/obj/item/clothing/suit/storage/vest/solgov/command
	...
	desc = "A synthetic armor vest with SOLAR AUTHORITY printed in gold lettering on the chest. This one has added webbing and ballistic plates."
	icon_state = "comwebvest"

/obj/item/clothing/suit/armor/pcarrier/blue/sol
	name = "peacekeeper plate carrier"
	desc = "A lightweight plate carrier vest in SA Peacekeeper colors. It can be equipped with armor plates, but provides no protection of its own."
