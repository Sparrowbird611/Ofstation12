...
/obj/item/clothing/head/soft/solgov
	name = "\improper Solar Authority cap"
	desc = "It's a ballcap in SA colors."
	icon_state = "solsoft"
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/soft/solgov/fleet
	name = "fleet cap"
	desc = "It's a navy blue field cap with the SA Fleet crest in a silver colour."
...
/obj/item/clothing/head/solgov/utility/fleet
	...
	desc = "A navy blue utility cover bearing the crest of the SA Fleet."
	icon_state = "navyutility"

/obj/item/clothing/head/solgov/utility/army
	name = "army utility cover"
	desc = "A green utility cover bearing the crest of the SA Army."
	icon_state = "greenutility"

/obj/item/clothing/head/solgov/utility/army/tan
	name = "tan utility cover"
	desc = "A tan utility cover bearing the crest of the SA Army."
	icon_state = "tanutility"

/obj/item/clothing/head/solgov/utility/army/urban
	name = "urban utility cover"
	desc = "A grey utility cover bearing the crest of the SA Army."
	icon_state = "greyutility"
...
/obj/item/clothing/head/solgov/service/expedition
	...
	desc = "A peaked black uniform cap belonging to the SA Expeditionary Corps."
...
/obj/item/clothing/head/solgov/service/expedition/command
	...
	desc = "A peaked black uniform cap belonging to the SA Expeditionary Corps. This one is trimmed in gold."
...
/obj/item/clothing/head/solgov/service/expedition/captain
	...
	desc = "A gold-trimmed peaked black uniform cap belonging to a Captain of the SA Expeditionary Corps."
...
/obj/item/clothing/head/beret/solgov
	...
	desc = "A beret in Solar Authority colors. For peacekeepers that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/marcom
	...
	desc = "A red beret with a gold insignia, denoting service in the SADF Mars Central Command. For brass who are more inclined towards style than safety."
	icon_state = "beret_redgold"

/obj/item/clothing/head/beret/solgov/stratcom
	name = "\improper STRATCOM beret"
	desc = "A grey beret with a silver insignia, denoting service in the SADF Strategic Command. For intelligence personnel who are more inclined towards style than safety."
	icon_state = "beret_graysilver"

/obj/item/clothing/head/beret/solgov/diplomatic
	name = "diplomatic security beret"
	desc = "A tan beret denoting service in the SA Army Diplomatic Security Group. For security personnel who are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition
	...
	desc = "A black beret belonging to the SA Expeditionary Corps. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/security
	...
	desc = "An SA Expeditionary Corps beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_security"

/obj/item/clothing/head/beret/solgov/expedition/medical
	name = "expeditionary medical beret"
	desc = "An SA Expeditionary Corps beret with a medical crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/engineering
	...
	desc = "An SA Expeditionary Corps beret with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_engineering"

/obj/item/clothing/head/beret/solgov/expedition/supply
	name = "expeditionary supply beret"
	desc = "An SA Expeditionary Corps beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_supply"

/obj/item/clothing/head/beret/solgov/expedition/service
	name = "expeditionary service beret"
	desc = "An SA Expeditionary Corps beret with a service crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/exploration
	...
	desc = "An SA Expeditionary Corps beret with an exploration crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/command
	...
	desc = "An SA Expeditionary Corps beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_command"

/obj/item/clothing/head/beret/solgov/expedition/branch
	name = "\improper Field Operations beret"
	desc = "An SA Expeditionary Corps beret carrying the insignia of the Field Operations section. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/branch/observatory
	...
	desc = "An SA Expeditionary Corps beret carrying the insignia of the Observatory section. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_observatory"

/obj/item/clothing/head/beret/solgov/fleet
	name = "fleet beret"
	desc = "A navy blue beret belonging to the SA Fleet. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy"

/obj/item/clothing/head/beret/solgov/fleet/security
	name = "fleet security beret"
	desc = "An SA Fleet beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_security"

/obj/item/clothing/head/beret/solgov/fleet/medical
	name = "fleet medical beret"
	desc = "An SA Fleet beret with a medical crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_medical"

/obj/item/clothing/head/beret/solgov/fleet/engineering
	name = "fleet engineering beret"
	desc = "An SA Fleet with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_engineering"

/obj/item/clothing/head/beret/solgov/fleet/supply
	name = "fleet supply beret"
	desc = "An SA Fleet beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_supply"

/obj/item/clothing/head/beret/solgov/fleet/service
	name = "fleet service beret"
	desc = "An SA Fleet beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_service"

/obj/item/clothing/head/beret/solgov/fleet/exploration
	name = "fleet exploration beret"
	desc = "An SA Fleet beret with an exploration crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_exploration"

/obj/item/clothing/head/beret/solgov/fleet/command
	name = "fleet officer's beret"
	desc = "An SA Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_command"

/obj/item/clothing/head/beret/solgov/fleet/dress
	name = "fleet dress beret"
	desc = "A white SA Fleet beret. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim"

/obj/item/clothing/head/beret/solgov/fleet/dress/command
	name = "fleet officer's dress beret"
	desc = "A white SA Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim_com"

/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "first fleet beret"
	desc = "An SA Fleet beret carrying the insignia of the First Fleet, the Sol Guard, stationed in Sol. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "second fleet beret"
	desc = "An SA Fleet beret carrying the insignia of the Second Fleet, the Home Guard, tasked with defense of Sol territories. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_second"

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "third fleet beret"
	desc = "An SA Fleet beret carrying the insignia of the Third Fleet, the Border Guard, guarding borders of Sol territory against Vox and pirates. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_third"

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "fourth fleet beret"
	desc = "An SA Fleet beret carrying the insignia of the Fourth Fleet, stationed on Skrell border. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_fourth"

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "fifth fleet beret"
	desc = "An SA Fleet beret carrying the insignia of the Fifth Fleet, the Quick Reaction Force, recently formed and outfitted with the latest tech. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/ushanka/solgov
	...
	desc = "An SA Expeditionary Corps synthfur-lined hat for operating in cold environments."
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/ushanka/solgov/fleet
	name = "fleet fur hat"
	desc = "An SA Fleet synthfur-lined hat for operating in cold environments."
	icon_state = "flushankadown"
	icon_state_up = "flushankaup"

/obj/item/clothing/head/ushanka/solgov/army
	name = "army fur hat"
	desc = "An SA Army synthfur-lined hat for operating in cold environments."
...
/obj/item/clothing/head/helmet/solgov/command
	name = "command helmet"
	desc = "A helmet with 'SOLAR AUTHORITY' printed on the back in gold lettering."
...
/obj/item/clothing/head/helmet/solgov/pilot/fleet
	...
	desc = "A pilot's helmet for operating the cockpit in style. This one is worn by members of the SA Fleet."
...
/obj/item/clothing/head/helmet/space/void/command
	...
	desc = "A light, radiation resistant voidsuit helmet commonly used among SA uniformed services."
