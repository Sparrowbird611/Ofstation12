...
/obj/item/clothing/suit/storage/solgov/service/expeditionary
	...
	desc = "A uniform service jacket belonging to the SA Expeditionary Corps."
...
/obj/item/clothing/suit/storage/solgov/service/fleet
	...
	desc = "A navy blue SA Fleet service jacket."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/snco
	...
	desc = "A navy blue SA Fleet service jacket with silver cuffs."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/officer
	...
	desc = "A navy blue SA Fleet dress jacket with silver accents."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/command
	...
	desc = "A navy blue SA Fleet dress jacket with gold accents."
...
/obj/item/clothing/suit/storage/solgov/service/army/medical/command
	...
	desc = "An SA Army service coat. This one has blue and gold markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/engineering
	...
	desc = "An SA Army service coat. This one has orange markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/engineering/command
	...
	desc = "An SA Army service coat. This one has orange and gold markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/supply
	...
	desc = "An SA Army service coat. This one has brown markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/security
	...
	desc = "An SA Army service coat. This one has red markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/security/command
	...
	desc = "An SA Army service coat. This one has red and gold markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/service
	...
	desc = "An SA Army service coat. This one has green markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/service/command
	...
	desc = "An SA Army service coat. This one has green and gold markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/exploration
	...
	desc = "An SA Army service coat. This one has purple markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/exploration/command
	...
	desc = "An SA Army service coat. This one has purple and gold markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/command
	...
	desc = "An SA Marine Corps service coat. This one has gold markings."
...
/obj/item/clothing/suit/storage/solgov/dress/expedition
	...
	desc = "A silver and black dress peacoat belonging to the SA Expeditionary Corps. Fashionable, for the 25th century at least."
	icon_state = "ecdress_xpl"
	item_state = "ecdress_xpl"
	sprite_sheets = list(
		SPECIES_UNATHI = 'icons/mob/species/unathi/onmob_suit_unathi.dmi'
...
/obj/item/clothing/suit/storage/solgov/dress/expedition/command
	...
	desc = "A gold and black dress peacoat belonging to the SA Expeditionary Corps. The height of fashion."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet
	...
	desc = "A navy blue SA Fleet dress jacket. Don't get near pasta sauce or vox."
	icon_state = "whitedress"
	item_state = "whitedress"

/obj/item/clothing/suit/storage/solgov/dress/fleet/snco
	name = "fleet dress SNCO jacket"
	desc = "A navy blue SA Fleet dress jacket with silver cuffs. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/officer
	...
	desc = "A navy blue SA Fleet dress jacket with silver accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/command
	...
	desc = "A navy blue SA Fleet dress jacket with gold accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/flag
	...
	desc = "A navy blue SA Fleet dress jacket with red accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/dress/solgov/fleet/sailor
	...
	desc = "A navy blue SA Fleet dress suit. Almost looks like a school-girl outfit."
	icon_state = "sailordress"
	item_state = "sailordress"

/obj/item/clothing/suit/dress/solgov/army
	name = "army dress jacket"
	desc = "A tailored black SA Army dress jacket with red trim. So sexy it hurts."
	icon_state = "blackdress"
	item_state = "blackdress"

/obj/item/clothing/suit/dress/solgov/army/command
	name = "army officer's dress jacket"
	desc = "A tailored black SA Army dress jacket with gold trim. Smells like ceremony."
...
/obj/item/clothing/suit/space/void/command
	...
	desc = "A light, radiation resistant voidsuit commonly used among SA uniformed services. This one has an EC seal on its chest plate and command department markings."
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')
