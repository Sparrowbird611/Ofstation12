...
/obj/item/book/manual/military_law
	name = "The Solar Authority Code of Military Justice"
	desc = "A brief overview of military law."
	icon_state = "bookSolGovLaw"
	author = "The Solar Authority"
	title = "The Solar Authority Code of Military Justice"
...
/obj/item/folder/envelope/captain/LateInitialize()
	...
	<h3>SOLAR AUTHORITY EXPEDITIONARY COMMAND</h3>
	<img src = sollogo.png>
	</center>
	...
	None of these systems are claimed by any entity recognized by the SA, so you have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no SA presence in that area. In case of distress calls, you will be the only vessel available; do not ignore them. We cannot afford any more PR backlash.<br>
	...
	<i>ADM Lau.</i></tt>
	<i>This paper has been stamped with the stamp of SA Expeditionary Command.</i>
	"}
...
/obj/item/paper/umbra
	...
	Procedure can be initiated only by transmission from SA Expeditionary Command via secure channel. The sender may not introduce themselves, but you shouldn't have trouble confirming the transmission source, I believe.<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to SA's national security, and is protected under codeword UMBRA. Only SA government employees and Skrell citizens aboard the SEV Torch are allowed access to this information on a need-to-know basis.</li>
	...
	<i>Regards, John.</i></tt>
	<i>This paper has been stamped with the stamp of Office of the General Secretary of SA.</i>
	"}
