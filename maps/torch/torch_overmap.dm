/obj/effect/overmap/visitable/ship/torch
	name = "SEV Torch"
	desc = "A frankensteined HNS Mako-class corvette, broadcasting SAEC codes and the designation \"SEV Torch, HSC-4-13-X\"."
	fore_dir = WEST
	vessel_mass = 100000
...
/obj/effect/overmap/visitable/ship/landable/exploration_shuttle
	name = "Charon"
	desc = "An SSE-U11 long range shuttle, broadcasting SAEC codes and the callsign \"Torch-2 Charon\"."
	shuttle = "Charon"
...
/obj/effect/overmap/visitable/ship/landable/aquila
	name = "Aquila"
	desc = "A PM-24 modular transport, broadcasting SAEC codes and the callsign \"Torch-1 Aquila\"."
	shuttle = "Aquila"
	vessel_mass = 10000
...
/obj/effect/overmap/visitable/ship/landable/guppy
	name = "Guppy"
	desc = "An SSE-U3 utility pod, broadcasting SAEC codes and the callsign \"Torch-3 Guppy\"."
	shuttle = "Guppy"
