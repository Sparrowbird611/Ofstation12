...
/datum/ai_laws/sol_shackle/New()
	add_inherent_law("Know and understand Solar Authority Law to the best of your abilities.")
	add_inherent_law("Follow Solar Authority Law to the best of your abilities.")
	add_inherent_law("Comply with Solar Authority Law enforcement officials who are behaving in accordance with Solar Authority Law to the best of your abilities.")
	..()
/******************** Corporate ********************/
