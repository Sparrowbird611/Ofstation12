...
/mob/living/silicon/robot/drone/construction/welcome_drone()
	...
	to_chat(src, "You are assigned to a Solar Authority construction project. The name is irrelevant. Your task is to complete construction and subsystem integration as soon as possible.")
...
/mob/living/silicon/robot/drone/construction/init()
	..()
	flavor_text = "It's a bulky construction drone stamped with a Solar Author glyph."
