/singleton/cultural_info/faction/scg
	...
	description = "The Solar Authority, commonly referred to as SolGov or the SA, is a federal republic \
	...
	the SA governs the majority of human space. Currently engaged in a cold war with the Confederation of Gilgamesh \
	Its primary governing bodies are the Assemblies which are led by an Assembly-elected secretary general. \
	Member states have a great degree of freedom in their actions, though the SA manages sapient rights, \
	domestic security, economic policy, and diplomacy for humanity as a whole. The SA's population is diverse \
	...
	its massive bureaucracy and the distance between worlds. Through its member states, the SA governs as one of the \
	most advanced and powerful civilisations in the known galaxy."


/singleton/cultural_info/faction/scg/fleet
	name = FACTION_FLEET
	description = "The Fleet is the primary component of the SA Defence Forces. It mostly protects SA space from pirates, smugglers, \
	...
	Any SA human citizen with at least a secondary school level of education can enlist into the Fleet, going through \
...
/singleton/cultural_info/faction/torchco
	...
	protocols, and xenoartifacts being 'lost' in transit, but nothing has been conclusively proven as of yet, and SA doubtless is \
...
/singleton/cultural_info/faction/gcc
	...
	bordered by the Solar Authority towards the galactic centre. The capital of the Confederation is the city of Ameranth on the planet of Terra \
	...
	Increasingly anti non-human, the GCC is in a cold war with the Solar Authority following  the Gaia Conflict, a large \
	scale conflict between the SA and GCC that saw a great deal of death and destruction. In Sol space \"Indies\" as they are known are \
...
/singleton/cultural_info/faction/remote
	...
	description = "The Expeditionary Corps is an SA agency tasked with exploration of uncharted space and worlds, \
	...
	Any SA citizen of age (18 and older) with no outstanding SA-wide warrants can sign up for a 2-year contract. \
...
/singleton/cultural_info/faction/police
	...
	description = "The Sol Federal (SFP) is a government law enforcement agency tasked with enforcing Solar Authority law, \
...
/singleton/cultural_info/faction/free
	...
	various traders and merchants from all over SA space and beyond. Colloquially known as the 'fifth megacorp', they control a sizeable fleet \
...
/singleton/cultural_info/faction/dais
	...
	and software, telecommunications equipment, and networking equipment based on Mars. It is the number one supplier of computer technology in The Sol Central \
	 Government, its systems used by most consumers and businesses within SolGov. DAIS is actually older than the Solar Authority and is one of the very \
