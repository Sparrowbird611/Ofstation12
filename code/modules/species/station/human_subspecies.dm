...
/datum/species/human/vatgrown
	...
	and flash-cloning are all illegal in SA space, there still exists a margin for those legitimate \
	...
	of the SA's rich elite.<br/><br/>Vat-grown humans tend to be paler than baseline, though those \
