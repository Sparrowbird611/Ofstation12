...
/obj/item/mech_component/chassis/pod
	...
	desc = "The NanoTrasen Katamari series cockpits have won a massive tender by SA few years back. No one is sure why, but these terrible things keep popping up on every government facility."
