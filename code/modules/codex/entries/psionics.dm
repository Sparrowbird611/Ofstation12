/datum/codex_entry/cuchulain_foundation
	...
	of private parties, the SA, and their own interests. They are also the single largest psionic registration \
	...
	bodies like the SA are unclear."
...
/datum/codex_entry/psionics
	...
	A decade of study has resulted in the SA determining that these psionics, mild as they are, don't pose \
